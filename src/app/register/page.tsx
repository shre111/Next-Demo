                    ...
                    {({ isSubmitting, errors }) => (
                        <Form className="space-y-7">
                            ...
                            <div className="relative">
                                ...
                                <ErrorMessage name="username" component="div" className="absolute text-red-300 text-sm mt-1 left-3 top-full" />
                            </div>
                            ...
                            >
                                <span className="absolute w-32 h-32 -top-8 -left-8 bg-white/20 rounded-full transform scale-0 group-hover:scale-150 transition-transform duration-500"></span>
